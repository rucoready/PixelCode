...
{
	UFoliageInstancedStaticMeshComponent* UComp = Cast<UFoliageInstancedStaticMeshComponent>(HitResult.GetComponent());
	UComp->ComponentTags.Contains(TEXT("Rock"));
	UE_LOG(LogTemp, Warning, TEXT("a;sdlfjka;sldkfja;sldkfja;slfjkas;ldkfja;sldkfj"));
}
